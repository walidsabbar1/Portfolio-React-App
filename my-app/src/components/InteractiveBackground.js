...
const InteractiveBackground = () => {
  ...
  useEffect(() => {
    ...
    const particles = [];
    const particleCount = 80; // Slightly reduced density for cleaner look
    ...
    class Particle {
      constructor() {
        ...
        // White color for difference blend mode
  ...
  return (
    <canvas 
      ...
      style={{
        ...
        pointerEvents: 'none',
        mixBlendMode: 'difference' // Inverts colors based on background
      }} 
    />
  );
};
